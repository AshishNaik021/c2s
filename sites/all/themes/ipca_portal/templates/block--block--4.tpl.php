...
<?php 
    ...
    $result = db_query("select * from pms_employee where extract(month from marriage_date) ='".date("m")."' and extract(day from marriage_date) ='".date("d")."' 
...
<?php 	$i++; }
if($i == 0){ ?> 
<div class="empty_record_message"> There are no records available for today's Anniversary .</div>
<?php }
