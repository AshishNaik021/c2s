...
<!--                <div class="content-btn2"><a href="<?php print $front_page.'user/logout'; ?>">Logout</a> </div>-->
                <?php if ($action_links): ?>
      ...
      <?php endif; ?>
        ...
        <div id="page" >            
            ...
            <div id="middle">
                <div class="section">
                    <?php print $messages; ?>                   
                     <div class="running-event"><?php print render($page['triptych_first']); ?></div>
                    <div class="banner"><?php print render($page['triptych_middle']); ?></div>
